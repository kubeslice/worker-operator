...
// SliceConfigurationSpec defines the desired state of SliceConfiguration
type SliceConfigurationSpec struct {
	IpCidr      string `json:"ipCidr,omitempty"` //FIXME:: do we need this?
...
// SliceConfigurationStatus defines the observed state of SliceConfiguration
type SliceConfigurationStatus struct {
...
// SliceConfiguration is the Schema for the sliceconfigurations API
type SliceConfiguration struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   SliceConfigurationSpec   `json:"spec,omitempty"`
	Status SliceConfigurationStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// SliceConfigurationList contains a list of SliceConfiguration
type SliceConfigurationList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SliceConfiguration `json:"items"`
}

func init() {
	SchemeBuilder.Register(&SliceConfiguration{}, &SliceConfigurationList{})
}
