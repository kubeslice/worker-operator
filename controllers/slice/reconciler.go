...
//+kubebuilder:webhook:path=/mutate-appsv1-deploy,mutating=true,failurePolicy=fail,groups="",resources=pods,verbs=create;update,versions=v1,name=mdeploy.kubeslice.io,admissionReviewVersions=v1,sideEffects=NoneOnDryRun
