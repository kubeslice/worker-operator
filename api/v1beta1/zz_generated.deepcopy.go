...
func (in *GwPodInfo) DeepCopyInto(out *GwPodInfo) {
	*out = *in
	if in.PodCreationTS != nil {
		in, out := &in.PodCreationTS, &out.PodCreationTS
		*out = (*in).DeepCopy()
	}
	if in.OriginalPodCreationTS != nil {
		in, out := &in.OriginalPodCreationTS, &out.OriginalPodCreationTS
		*out = (*in).DeepCopy()
	}
...
func (in *SliceGatewayConfig) DeepCopyInto(out *SliceGatewayConfig) {
	*out = *in
	if in.SliceGatewayNodePorts != nil {
		in, out := &in.SliceGatewayNodePorts, &out.SliceGatewayNodePorts
		*out = make([]int, len(*in))
		copy(*out, *in)
	}
	...
	if in.SliceGatewayRemoteNodePorts != nil {
		in, out := &in.SliceGatewayRemoteNodePorts, &out.SliceGatewayRemoteNodePorts
		*out = make([]int, len(*in))
		copy(*out, *in)
	}
	if in.SliceGatewayIntermediateDeployments != nil {
		in, out := &in.SliceGatewayIntermediateDeployments, &out.SliceGatewayIntermediateDeployments
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.SliceGatewayServerLBIPs != nil {
		in, out := &in.SliceGatewayServerLBIPs, &out.SliceGatewayServerLBIPs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
