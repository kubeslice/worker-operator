...
func (in *SliceGatewayConfig) DeepCopyInto(out *SliceGatewayConfig) {
	*out = *in
	...
	if in.SliceGatewayRemoteVpnIPs != nil {
		in, out := &in.SliceGatewayRemoteVpnIPs, &out.SliceGatewayRemoteVpnIPs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.SliceGatewayLocalVpnIPs != nil {
		in, out := &in.SliceGatewayLocalVpnIPs, &out.SliceGatewayLocalVpnIPs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
